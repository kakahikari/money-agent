    ...
    data () {
      return {
        ...
        fields: {
          ...
          totalWithdrawal: { label: this.$root.i18n('withdrawal amount'), sortable: true },
          timeWithdrawal: { label: this.$root.i18n('number of withdrawals') },
          peopleWithdrawal: { label: this.$root.i18n('number of people making withdrawals'), sortable: true },
